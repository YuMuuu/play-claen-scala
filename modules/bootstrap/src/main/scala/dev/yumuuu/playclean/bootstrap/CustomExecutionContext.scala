 ...
 *
 * default の ExecutionContext を利用すべきでない処理、たとえばデータベースアクセスや
 * ブロッキング I/O を実行する場合に利用する。利用する dispatcher の名前を指定して継承する。
 *
 * {{{
 * @Singleton
 ...
 *
 * @param system dispatcher を提供する ActorSystem
 * @param name   dispatcher の設定上のパス
 * @see [[https://pekko.apache.org/docs/pekko/current/dispatchers.html Pekko Dispatchers]]
 */
